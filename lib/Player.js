...
class Player extends Base {
	...
	//renewal Lisence
	 switch(data.rankinggrade2) { 
		case '1': this.license = '초보'
		break 
		case '2': this.license = '루키'
		break
		case '3': this.license = 'L3' 
		break 
		case '4': this.license = 'L2' 
		break
		case '5': this.license = 'L1' 
		break 
		case '6': this.license ='PRO' 
		break
		default: this.license = 'none' 
		break
	 }
